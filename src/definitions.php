...
return [
    ...
    "compras" => \DI\autowire(Compras::class),
    "cooperativas" => \DI\autowire(Cooperativas::class),
    "horas_trabajadas" => \DI\autowire(HorasTrabajadas::class),
    "ingresos" => \DI\autowire(Ingresos::class),
    "movimientos_stock" => \DI\autowire(MovimientosStock::class),
    "pagos_socios" => \DI\autowire(PagosSocios::class),
