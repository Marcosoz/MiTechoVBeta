...
$CONFIG = [
    ...
    "AES_ENCRYPTION_KEY" => "rAgS+B1BHhYvB+V4oGHMhiqBBv93vGK5WBwLoy9gods=", // AES encryption key (base64 encoded)
    ...
    // Export Log
    "EXPORT_PATH" => "export-de8d5e86-44e5-4b2c-9d69-3206442e37a6", // Export folder
    ...
    "CASE_SENSITIVE_PASSWORD" => false, // Case-sensitive password (deprecated)
    "MIGRATE_PASSWORD" => true, // Migrate password
