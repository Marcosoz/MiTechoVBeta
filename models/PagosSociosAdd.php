 ...
 * Page class
 */
class PagosSociosAdd extends PagosSocios
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "PagosSociosAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "PagosSociosAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$oldRow) { // Record not loaded
                    ...
                    $this->terminate("PagosSociosList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "PagosSociosList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "PagosSociosView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "PagosSociosList") {
                            ...
                            $returnUrl = "PagosSociosList"; // Return list page content
                        }
                    }
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'concepto' before field var 'x_concepto'
        $val = $this->getFormValue("concepto", null) ?? $this->getFormValue("x_concepto", null);
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->concepto->EditValue = !$this->concepto->Raw ? HtmlDecode($this->concepto->CurrentValue) : $this->concepto->CurrentValue;
    ...
    protected function getAddRow(): array
    {
        ...
        // concepto
        $this->concepto->setDbValueDef($newRow, $this->concepto->CurrentValue, false);
    ...
    protected function setupBreadcrumb(): void
    {
        ...
        $url = CurrentUrl();
        $breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PagosSociosList"), "", $this->TableVar, true);
