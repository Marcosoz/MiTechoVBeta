...
/**
 * Table class for actividad_log
 */
class ActividadLog extends DbTable implements LookupTableInterface
{
    ...
    // Fields
    public DbField $id;
    public DbField $usuario_id;
    public DbField $cooperativa_id;
    public DbField $accion;
    public DbField $detalles;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "actividad_log"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // usuario_id
        $this->usuario_id = new DbField(
            $this, // Table
            'x_usuario_id', // Variable name
            'usuario_id', // Name
            '`usuario_id`', // Expression
            '`usuario_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`usuario_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->usuario_id->InputTextType = "text";
        $this->usuario_id->Raw = true;
        $this->usuario_id->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->usuario_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        // accion
        $this->accion = new DbField(
            $this, // Table
            'x_accion', // Variable name
            'accion', // Name
            '`accion`', // Expression
            '`accion`', // Basic search expression
            200, // Type
            150, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`accion`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->accion->InputTextType = "text";
        $this->accion->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['accion'] = &$this->accion;

        // detalles
        $this->detalles = new DbField(
            $this, // Table
            'x_detalles', // Variable name
            'detalles', // Name
            '`detalles`', // Expression
            '`detalles`', // Basic search expression
            200, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`detalles`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->detalles->InputTextType = "text";
        $this->detalles->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "actividad_log";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("ActividadLogList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "ActividadLogView" => $this->language->phrase("View"),
            "ActividadLogEdit" => $this->language->phrase("Edit"),
            "ActividadLogAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ActividadLogView",
            Config("API_ADD_ACTION") => "ActividadLogAdd",
            Config("API_EDIT_ACTION") => "ActividadLogEdit",
            Config("API_DELETE_ACTION") => "ActividadLogDelete",
            Config("API_LIST_ACTION") => "ActividadLogList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ActividadLogView", $parm);
        } else {
            $url = $this->keyUrl("ActividadLogView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ActividadLogEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ActividadLogList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ActividadLogAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ActividadLogList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ActividadLogDelete", $parm);
        }
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->detalles);
