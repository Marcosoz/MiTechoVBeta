...
/**
 * Table class for movimientos_stock
 */
class MovimientosStock extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "movimientos_stock"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->tipo_movimiento = new DbField(
            $this, // Table
            'x_tipo_movimiento', // Variable name
            'tipo_movimiento', // Name
            '`tipo_movimiento`', // Expression
            '`tipo_movimiento`', // Basic search expression
            200, // Type
            7, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`tipo_movimiento`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tipo_movimiento->InputTextType = "text";
        $this->tipo_movimiento->Raw = true;
        $this->tipo_movimiento->Nullable = false; // NOT NULL field
        $this->tipo_movimiento->Required = true; // Required field
        $this->tipo_movimiento->Lookup = new Lookup($this->tipo_movimiento, 'movimientos_stock', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
        $this->tipo_movimiento->OptionCount = 2;
        $this->tipo_movimiento->SearchOperators = ["=", "<>"];
        $this->Fields['tipo_movimiento'] = &$this->tipo_movimiento;
        ...
        $this->cantidad->DefaultErrorMessage = $this->language->phrase("IncorrectFloat");
        ...
        $this->motivo->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "movimientos_stock";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("MovimientosStockList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "MovimientosStockView" => $this->language->phrase("View"),
            "MovimientosStockEdit" => $this->language->phrase("Edit"),
            "MovimientosStockAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MovimientosStockView",
            Config("API_ADD_ACTION") => "MovimientosStockAdd",
            Config("API_EDIT_ACTION") => "MovimientosStockEdit",
            Config("API_DELETE_ACTION") => "MovimientosStockDelete",
            Config("API_LIST_ACTION") => "MovimientosStockList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MovimientosStockView", $parm);
        } else {
            $url = $this->keyUrl("MovimientosStockView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "MovimientosStockAdd?" . $parm;
        } else {
            $url = "MovimientosStockAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovimientosStockEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovimientosStockList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovimientosStockAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovimientosStockList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("MovimientosStockDelete", $parm);
        }
    }
