 ...
 */
class Stock extends DbTable implements LookupTableInterface
{
    ...
    // Fields
    public DbField $id;
    public DbField $nombre_material;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "stock"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nombre_material
        $this->nombre_material = new DbField(
            $this, // Table
            'x_nombre_material', // Variable name
            'nombre_material', // Name
            '`nombre_material`', // Expression
            '`nombre_material`', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nombre_material`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nombre_material->InputTextType = "text";
        $this->nombre_material->Nullable = false; // NOT NULL field
        $this->nombre_material->Required = true; // Required field
        $this->nombre_material->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['nombre_material'] = &$this->nombre_material;

        // unidad
        $this->unidad = new DbField(
            $this, // Table
            'x_unidad', // Variable name
            'unidad', // Name
            '`unidad`', // Expression
            '`unidad`', // Basic search expression
            200, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`unidad`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->unidad->InputTextType = "text";
        $this->unidad->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    protected function loadDbValues(?array $row)
    {
        ...
        $this->nombre_material->DbValue = $row['nombre_material'];
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("StockList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "StockView" => $this->language->phrase("View"),
            "StockEdit" => $this->language->phrase("Edit"),
            "StockAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "StockView",
            Config("API_ADD_ACTION") => "StockAdd",
            Config("API_EDIT_ACTION") => "StockEdit",
            Config("API_DELETE_ACTION") => "StockDelete",
            Config("API_LIST_ACTION") => "StockList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StockView", $parm);
        } else {
            $url = $this->keyUrl("StockView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StockEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StockList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StockList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("StockDelete", $parm);
        }
    }
