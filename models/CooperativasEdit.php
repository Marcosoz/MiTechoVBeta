 ...
 * Page class
 */
class CooperativasEdit extends Cooperativas
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "CooperativasEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "CooperativasEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("CooperativasList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "CooperativasList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "CooperativasList") {
                            ...
                            $returnUrl = "CooperativasList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // departamento
        $this->departamento->setDbValueDef($newRow, $this->departamento->CurrentValue, $this->departamento->ReadOnly);

        // ciudad
        $this->ciudad->setDbValueDef($newRow, $this->ciudad->CurrentValue, $this->ciudad->ReadOnly);
    ...
    protected function restoreEditFormFromRow(array $row): void
    {
        ...
        if (isset($row['departamento'])) { // departamento
            $this->departamento->CurrentValue = $row['departamento'];
        }
    ...
    protected function setupBreadcrumb(): void
    {
        ...
        $url = CurrentUrl();
        $breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("CooperativasList"), "", $this->TableVar, true);
        $pageId = "edit";
