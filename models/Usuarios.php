 ...
 */
class Usuarios extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "usuarios"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // username
        $this->username = new DbField(
            $this, // Table
            'x_username', // Variable name
            'username', // Name
            '`username`', // Expression
        ...
        $this->username->InputTextType = "text";
        $this->username->Nullable = false; // NOT NULL field
        $this->username->Required = true; // Required field
        $this->username->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['username'] = &$this->username;

        // password
        $this->password = new DbField(
            $this, // Table
            'x_password', // Variable name
            'password', // Name
            '`password`', // Expression
        ...
        $this->password->InputTextType = "text";
        $this->password->Nullable = false; // NOT NULL field
        $this->password->Required = true; // Required field
        $this->password->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->nombre_completo->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->_userlevel->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->_userlevel->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("UsuariosList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "UsuariosView" => $this->language->phrase("View"),
            "UsuariosEdit" => $this->language->phrase("Edit"),
            "UsuariosAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "UsuariosView",
            Config("API_ADD_ACTION") => "UsuariosAdd",
            Config("API_EDIT_ACTION") => "UsuariosEdit",
            Config("API_DELETE_ACTION") => "UsuariosDelete",
            Config("API_LIST_ACTION") => "UsuariosList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UsuariosView", $parm);
        } else {
            $url = $this->keyUrl("UsuariosView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UsuariosEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UsuariosList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UsuariosAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UsuariosList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("UsuariosDelete", $parm);
        }
    }
