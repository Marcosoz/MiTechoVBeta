 ...
 * Page class
 */
class ProveedoresDelete extends Proveedores
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ProveedoresDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "ProveedoresDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("ProveedoresList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("ProveedoresList"); // Return to list
                return;
            }
        }
