 ...
 * Page class
 */
class SociosDelete extends Socios
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "SociosDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "SociosDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("SociosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("SociosList"); // Return to list
                return;
            }
        }
