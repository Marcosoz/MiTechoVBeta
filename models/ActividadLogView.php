 ...
 * Page class
 */
class ActividadLogView extends ActividadLog
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ActividadLogView";
    ...
    // CSS class/style
    public string $CurrentPageName = "ActividadLogView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ActividadLogList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ActividadLogList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
