 ...
 * Page class
 */
class ActividadLogAdd extends ActividadLog
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "ActividadLogAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "ActividadLogAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ActividadLogView") {
    ...
    protected function getAddRow(): array
    {
        ...
        // usuario_id
        $this->usuario_id->setDbValueDef($newRow, $this->usuario_id->CurrentValue, false);

        // cooperativa_id
        $this->cooperativa_id->setDbValueDef($newRow, $this->cooperativa_id->CurrentValue, false);

        // accion
        $this->accion->setDbValueDef($newRow, $this->accion->CurrentValue, false);

        // detalles
        $this->detalles->setDbValueDef($newRow, $this->detalles->CurrentValue, false);
