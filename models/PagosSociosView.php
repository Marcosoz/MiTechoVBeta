 ...
 * Page class
 */
class PagosSociosView extends PagosSocios
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PagosSociosView";
    ...
    // CSS class/style
    public string $CurrentPageName = "PagosSociosView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PagosSociosList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PagosSociosList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
