 ...
 */
class Compras extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "compras"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->proveedor_id = new DbField(
            $this, // Table
            'x_proveedor_id', // Variable name
            'proveedor_id', // Name
            '`proveedor_id`', // Expression
            '`proveedor_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`proveedor_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->proveedor_id->InputTextType = "text";
        $this->proveedor_id->Raw = true;
        $this->proveedor_id->Nullable = false; // NOT NULL field
        $this->proveedor_id->Required = true; // Required field
        $this->proveedor_id->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->proveedor_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['proveedor_id'] = &$this->proveedor_id;
        ...
        $this->monto->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['monto'] = &$this->monto;

        // saldo_pendiente
        $this->saldo_pendiente = new DbField(
            $this, // Table
            'x_saldo_pendiente', // Variable name
            'saldo_pendiente', // Name
            '`saldo_pendiente`', // Expression
            '`saldo_pendiente`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`saldo_pendiente`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->saldo_pendiente->addMethod("getDefault", fn() => 0.00);
        $this->saldo_pendiente->InputTextType = "text";
        $this->saldo_pendiente->Raw = true;
        $this->saldo_pendiente->DefaultErrorMessage = $this->language->phrase("IncorrectFloat");
        $this->saldo_pendiente->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['saldo_pendiente'] = &$this->saldo_pendiente;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "compras";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("ComprasList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "ComprasView" => $this->language->phrase("View"),
            "ComprasEdit" => $this->language->phrase("Edit"),
            "ComprasAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ComprasView",
            Config("API_ADD_ACTION") => "ComprasAdd",
            Config("API_EDIT_ACTION") => "ComprasEdit",
            Config("API_DELETE_ACTION") => "ComprasDelete",
            Config("API_LIST_ACTION") => "ComprasList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ComprasView", $parm);
        } else {
            $url = $this->keyUrl("ComprasView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ComprasEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ComprasList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ComprasAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ComprasList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ComprasDelete", $parm);
        }
    }
