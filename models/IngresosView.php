 ...
 * Page class
 */
class IngresosView extends Ingresos
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "IngresosView";
    ...
    // CSS class/style
    public string $CurrentPageName = "IngresosView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "IngresosList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "IngresosList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
