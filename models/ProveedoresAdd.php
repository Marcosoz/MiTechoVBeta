 ...
 * Page class
 */
class ProveedoresAdd extends Proveedores
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "ProveedoresAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "ProveedoresAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ProveedoresView") {
    ...
    protected function getAddRow(): array
    {
        ...
        // contacto
        $this->contacto->setDbValueDef($newRow, $this->contacto->CurrentValue, false);
