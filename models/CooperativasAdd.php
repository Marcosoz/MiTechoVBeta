 ...
 * Page class
 */
class CooperativasAdd extends Cooperativas
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "CooperativasAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "CooperativasAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CooperativasView") {
