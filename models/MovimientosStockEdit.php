 ...
 * Page class
 */
class MovimientosStockEdit extends MovimientosStock
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "MovimientosStockEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "MovimientosStockEdit";
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // stock_id
        $this->stock_id->setDbValueDef($newRow, $this->stock_id->CurrentValue, $this->stock_id->ReadOnly);

        // tipo_movimiento
        $this->tipo_movimiento->setDbValueDef($newRow, $this->tipo_movimiento->CurrentValue, $this->tipo_movimiento->ReadOnly);

        // cantidad
        $this->cantidad->setDbValueDef($newRow, $this->cantidad->CurrentValue, $this->cantidad->ReadOnly);

        // motivo
        $this->motivo->setDbValueDef($newRow, $this->motivo->CurrentValue, $this->motivo->ReadOnly);
    ...
    protected function restoreEditFormFromRow(array $row): void
    {
        if (isset($row['stock_id'])) { // stock_id
            $this->stock_id->CurrentValue = $row['stock_id'];
        }
        if (isset($row['tipo_movimiento'])) { // tipo_movimiento
            $this->tipo_movimiento->CurrentValue = $row['tipo_movimiento'];
        }
