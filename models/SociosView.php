 ...
 * Page class
 */
class SociosView extends Socios
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "SociosView";
    ...
    // CSS class/style
    public string $CurrentPageName = "SociosView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "SociosList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SociosList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
