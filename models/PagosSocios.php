...
/**
 * Table class for pagos_socios
 */
class PagosSocios extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "pagos_socios"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "pagos_socios";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("PagosSociosList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "PagosSociosView" => $this->language->phrase("View"),
            "PagosSociosEdit" => $this->language->phrase("Edit"),
            "PagosSociosAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PagosSociosView",
            Config("API_ADD_ACTION") => "PagosSociosAdd",
            Config("API_EDIT_ACTION") => "PagosSociosEdit",
            Config("API_DELETE_ACTION") => "PagosSociosDelete",
            Config("API_LIST_ACTION") => "PagosSociosList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PagosSociosView", $parm);
        } else {
            $url = $this->keyUrl("PagosSociosView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosSociosEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosSociosList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosSociosAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosSociosList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PagosSociosDelete", $parm);
        }
    }
