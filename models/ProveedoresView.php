 ...
 * Page class
 */
class ProveedoresView extends Proveedores
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ProveedoresView";
    ...
    // CSS class/style
    public string $CurrentPageName = "ProveedoresView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProveedoresList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProveedoresList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
