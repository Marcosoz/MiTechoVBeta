 ...
 * Page class
 */
class MovimientosStockDelete extends MovimientosStock
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "MovimientosStockDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "MovimientosStockDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("MovimientosStockList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("MovimientosStockList"); // Return to list
                return;
            }
        }
