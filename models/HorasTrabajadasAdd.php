 ...
 * Page class
 */
class HorasTrabajadasAdd extends HorasTrabajadas
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "HorasTrabajadasAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "HorasTrabajadasAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "HorasTrabajadasView") {
    ...
    protected function getAddRow(): array
    {
        ...
        // horas
        $this->horas->setDbValueDef($newRow, $this->horas->CurrentValue, false);

        // tarea
        $this->tarea->setDbValueDef($newRow, $this->tarea->CurrentValue, false);
