...
class StockAdd extends Stock
{
    ...
    // Page object name
    public string $PageObjName = "StockAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "StockAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "StockView") {
    ...
    protected function getAddRow(): array
    {
        ...
        // nombre_material
        $this->nombre_material->setDbValueDef($newRow, $this->nombre_material->CurrentValue, false);

        // unidad
        $this->unidad->setDbValueDef($newRow, $this->unidad->CurrentValue, false);

        // cantidad
        $this->cantidad->setDbValueDef($newRow, $this->cantidad->CurrentValue, strval($this->cantidad->CurrentValue) == "");
