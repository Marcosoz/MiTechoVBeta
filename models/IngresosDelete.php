 ...
 * Page class
 */
class IngresosDelete extends Ingresos
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "IngresosDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "IngresosDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("IngresosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("IngresosList"); // Return to list
                return;
            }
        }
