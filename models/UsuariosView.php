 ...
 * Page class
 */
class UsuariosView extends Usuarios
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "UsuariosView";
    ...
    // CSS class/style
    public string $CurrentPageName = "UsuariosView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "UsuariosList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UsuariosList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
