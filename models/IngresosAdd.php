 ...
 * Page class
 */
class IngresosAdd extends Ingresos
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "IngresosAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "IngresosAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "IngresosView") {
    ...
    protected function getAddRow(): array
    {
        ...
        // tipo_ingreso
        $this->tipo_ingreso->setDbValueDef($newRow, $this->tipo_ingreso->CurrentValue, false);
