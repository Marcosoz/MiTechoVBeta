 ...
 * Page class
 */
class MovimientosStockView extends MovimientosStock
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "MovimientosStockView";
    ...
    // CSS class/style
    public string $CurrentPageName = "MovimientosStockView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "MovimientosStockList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MovimientosStockList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
