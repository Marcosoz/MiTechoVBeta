 ...
 * Page class
 */
class StockDelete extends Stock
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "StockDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "StockDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("StockList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("StockList"); // Return to list
                return;
            }
        }
