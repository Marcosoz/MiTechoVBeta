...
class StockView extends Stock
{
    ...
    // Page object name
    public string $PageObjName = "StockView";
    ...
    // CSS class/style
    public string $CurrentPageName = "StockView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "StockList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "StockList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
