 ...
 * Page class
 */
class HorasTrabajadasDelete extends HorasTrabajadas
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "HorasTrabajadasDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "HorasTrabajadasDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("HorasTrabajadasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("HorasTrabajadasList"); // Return to list
                return;
            }
        }
