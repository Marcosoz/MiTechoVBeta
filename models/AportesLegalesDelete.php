 ...
 * Page class
 */
class AportesLegalesDelete extends AportesLegales
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "AportesLegalesDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "AportesLegalesDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("AportesLegalesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("AportesLegalesList"); // Return to list
                return;
            }
        }
