 ...
 * Page class
 */
class CooperativasDelete extends Cooperativas
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "CooperativasDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "CooperativasDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("CooperativasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("CooperativasList"); // Return to list
                return;
            }
        }
