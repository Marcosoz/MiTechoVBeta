 ...
 * Page class
 */
class UsuariosDelete extends Usuarios
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "UsuariosDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("UsuariosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("UsuariosList"); // Return to list
                return;
            }
        }
