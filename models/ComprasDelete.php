 ...
 * Page class
 */
class ComprasDelete extends Compras
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ComprasDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "ComprasDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("ComprasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("ComprasList"); // Return to list
                return;
            }
        }
