...
/**
 * Table class for aportes_legales
 */
class AportesLegales extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "aportes_legales"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "aportes_legales";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("AportesLegalesList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "AportesLegalesView" => $this->language->phrase("View"),
            "AportesLegalesEdit" => $this->language->phrase("Edit"),
            "AportesLegalesAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "AportesLegalesView",
            Config("API_ADD_ACTION") => "AportesLegalesAdd",
            Config("API_EDIT_ACTION") => "AportesLegalesEdit",
            Config("API_DELETE_ACTION") => "AportesLegalesDelete",
            Config("API_LIST_ACTION") => "AportesLegalesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AportesLegalesView", $parm);
        } else {
            $url = $this->keyUrl("AportesLegalesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "AportesLegalesAdd?" . $parm;
        } else {
            $url = "AportesLegalesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AportesLegalesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AportesLegalesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AportesLegalesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AportesLegalesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("AportesLegalesDelete", $parm);
        }
    }
