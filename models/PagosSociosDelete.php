 ...
 * Page class
 */
class PagosSociosDelete extends PagosSocios
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PagosSociosDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "PagosSociosDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("PagosSociosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("PagosSociosList"); // Return to list
                return;
            }
        }
