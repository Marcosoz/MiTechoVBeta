 ...
 * Page class
 */
class ActividadLogDelete extends ActividadLog
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ActividadLogDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "ActividadLogDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("ActividadLogList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("ActividadLogList"); // Return to list
                return;
            }
        }
