...
/**
 * Table class for cooperativas
 */
class Cooperativas extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "cooperativas"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "cooperativas";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("CooperativasList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "CooperativasView" => $this->language->phrase("View"),
            "CooperativasEdit" => $this->language->phrase("Edit"),
            "CooperativasAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CooperativasView",
            Config("API_ADD_ACTION") => "CooperativasAdd",
            Config("API_EDIT_ACTION") => "CooperativasEdit",
            Config("API_DELETE_ACTION") => "CooperativasDelete",
            Config("API_LIST_ACTION") => "CooperativasList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CooperativasView", $parm);
        } else {
            $url = $this->keyUrl("CooperativasView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CooperativasEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CooperativasList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CooperativasAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CooperativasList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("CooperativasDelete", $parm);
        }
    }
