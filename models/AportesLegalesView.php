 ...
 * Page class
 */
class AportesLegalesView extends AportesLegales
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "AportesLegalesView";
    ...
    // CSS class/style
    public string $CurrentPageName = "AportesLegalesView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AportesLegalesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AportesLegalesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
