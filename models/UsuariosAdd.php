 ...
 * Page class
 */
class UsuariosAdd extends Usuarios
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "UsuariosAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "UsuariosAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "UsuariosView") {
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->username->CurrentValue != "") { // Check field with unique index
            $filter = "(`username` = '" . AdjustSql($this->username->CurrentValue) . "')";
    ...
    protected function getAddRow(): array
    {
        ...
        // username
        $this->username->setDbValueDef($newRow, $this->username->CurrentValue, false);

        // password
        $this->password->setDbValueDef($newRow, $this->password->CurrentValue, false);
        ...
        // userlevel
        $this->_userlevel->setDbValueDef($newRow, $this->_userlevel->CurrentValue, strval($this->_userlevel->CurrentValue) == "");
