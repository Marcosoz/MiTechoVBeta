 ...
 * Page class
 */
class ComprasEdit extends Compras
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "ComprasEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "ComprasEdit";
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // proveedor_id
        $this->proveedor_id->setDbValueDef($newRow, $this->proveedor_id->CurrentValue, $this->proveedor_id->ReadOnly);
        ...
        // monto
        $this->monto->setDbValueDef($newRow, $this->monto->CurrentValue, $this->monto->ReadOnly);

        // saldo_pendiente
        $this->saldo_pendiente->setDbValueDef($newRow, $this->saldo_pendiente->CurrentValue, $this->saldo_pendiente->ReadOnly);
    ...
    {
        if (isset($row['proveedor_id'])) { // proveedor_id
            $this->proveedor_id->CurrentValue = $row['proveedor_id'];
        }
        ...
        if (isset($row['saldo_pendiente'])) { // saldo_pendiente
            $this->saldo_pendiente->CurrentValue = $row['saldo_pendiente'];
        }
