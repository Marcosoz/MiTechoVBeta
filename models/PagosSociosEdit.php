 ...
 * Page class
 */
class PagosSociosEdit extends PagosSocios
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "PagosSociosEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "PagosSociosEdit";
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // concepto
        $this->concepto->setDbValueDef($newRow, $this->concepto->CurrentValue, $this->concepto->ReadOnly);
