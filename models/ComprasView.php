 ...
 * Page class
 */
class ComprasView extends Compras
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ComprasView";
    ...
    // CSS class/style
    public string $CurrentPageName = "ComprasView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ComprasList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ComprasList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
