 ...
 * Page class
 */
class CooperativasView extends Cooperativas
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "CooperativasView";
    ...
    // CSS class/style
    public string $CurrentPageName = "CooperativasView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CooperativasList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CooperativasList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
