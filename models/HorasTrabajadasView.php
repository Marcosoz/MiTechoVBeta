 ...
 * Page class
 */
class HorasTrabajadasView extends HorasTrabajadas
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "HorasTrabajadasView";
    ...
    // CSS class/style
    public string $CurrentPageName = "HorasTrabajadasView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "HorasTrabajadasList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "HorasTrabajadasList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
